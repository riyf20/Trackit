    ...
    return (
        <ThemedView className='flex w-full h-full relative'>
            ...
            >
                ...
                {isLiquidGlassAvailable() ?
                    <>
                        <GlassView style={{width: '88%', height: 100, borderRadius: 18, alignItems: 'center', justifyContent: 'center', zIndex: 10}} tintColor={theme === "#ECEDEE" ? 'black' : 'gray'}>
                            <Progress value={percentage} style={{width: '90%', height: 52, backgroundColor: theme==="#ECEDEE" ? 'gray' : 'darkgray', justifyContent: 'center'}}>
                        ...
                        <GlassView style={{width: '87%', borderRadius: 18, justifyContent: 'center', paddingBottom: 20, paddingTop: 50, top: -30}} tintColor={theme === "#ECEDEE" ? '#0F0F0F' : 'darkgray'}>
                        ...
                        <GlassView style={{width: '88%', borderRadius: 18, alignItems: 'center',justifyContent: 'center', zIndex: 10, padding: 20, display: 'flex', flexDirection: 'row', gap: 6}} tintColor={theme === "#ECEDEE" ? 'black' : 'gray'}>
                            <IconSymbol name='doc.text' size={22} color={theme} />
                            <Divider
                                orientation="vertical"
                                style={{backgroundColor: theme==='#ECEDEE' ? 'white' : 'black', height: '100%'}}
                            />
                        ...
                        <GlassView style={{width: '88%', height: 'auto', borderRadius: 18, alignItems: 'center',justifyContent: 'center', zIndex: 10, padding: 20, display: 'flex', flexDirection: 'row', gap: 6}} tintColor={theme === "#ECEDEE" ? 'black' : 'gray'}>
                            <IconSymbol name='list.bullet.rectangle' size={22} color={theme} />
                            <Divider
                                orientation="vertical"
                                style={{backgroundColor: theme==='#ECEDEE' ? 'white' : 'black', height: '100%'}}
                            />
                            <ThemedText type='onboardingMain' style={{marginRight: 'auto'}} >Contract Details</ThemedText>
                            <View className={` border-2 border-transparent rounded-full p-[4px] ${iconPressed ? (theme==='#ECEDEE' ? 'bg-white/20' : 'bg-black/20') : 'bg-transparent' } ${contractDetailsOpen && 'z-100'}`}>
                                ...
                                >
                                    <IconSymbol name='ellipsis' size={22} color={theme} style={{transform: [{ rotate: '90deg' }]}} />
                                </Pressable>
                            </View>
                        </GlassView>
                        <GlassView style={{width: '87%', borderRadius: 18, justifyContent: 'center', paddingBottom: 20, paddingTop: 50, top: -30}} tintColor={theme === "#ECEDEE" ? '#0F0F0F' : 'darkgray'}>
                    ...
                    :
                    <>
                        <BlurView style={{width: '88%', height: 100, borderRadius: 18, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', zIndex: 10}} tint={theme === "#ECEDEE" ? 'dark' : 'dark'} intensity={theme === "#ECEDEE" ? 100 : 30}>
                            <Progress value={percentage} style={{width: '90%', height: 52, backgroundColor: theme==="#ECEDEE" ? 'gray' : 'darkgray', justifyContent: 'center'}}>
                                <Animated.View style={progressStyle}>
                                    <ProgressFilledTrack style={{height: 60}} />
                                </Animated.View>
                        ...
                        <BlurView style={{width: '87%', height: 'auto', borderRadius: 18, justifyContent: 'center', paddingBottom: 20, paddingTop: 50, top: -30, overflow: 'hidden'}} tint={theme === "#ECEDEE" ? 'light' : 'dark'} intensity={theme === "#ECEDEE" ? 30 : 40}>
                        ...
                        <BlurView style={{width: '88%', borderRadius: 18, alignItems: 'center',justifyContent: 'center', zIndex: 10, padding: 20, display: 'flex', flexDirection: 'row', gap: 6, overflow: 'hidden'}} tint={theme === "#ECEDEE" ? 'dark' : 'dark'} intensity={theme === "#ECEDEE" ? 100 : 30}>
                            <IconSymbol name='doc.text' size={22} color={theme} />
                            <Divider
                                orientation="vertical"
                                style={{backgroundColor: theme==='#ECEDEE' ? 'white' : 'black', height: '100%'}}
                        ...
                        <BlurView style={{width: '87%', borderRadius: 18, justifyContent: 'center', paddingBottom: 20, paddingTop: 50, top: -30, overflow: 'hidden'}} tint={theme === "#ECEDEE" ? 'light' : 'dark'} intensity={theme === "#ECEDEE" ? 30 : 40}>
                        ...
                        <BlurView style={{width: '88%', height: 'auto', borderRadius: 18, alignItems: 'center',justifyContent: 'center', zIndex: 10, padding: 20, display: 'flex', flexDirection: 'row', gap: 6, overflow:'hidden'}} tint={theme === "#ECEDEE" ? 'dark' : 'dark'} intensity={theme === "#ECEDEE" ? 100 : 30}>
                            <IconSymbol name='list.bullet.rectangle' size={22} color={theme} />
                            <Divider
                                orientation="vertical"
                                style={{backgroundColor: theme==='#ECEDEE' ? 'white' : 'black', height: '100%'}}
