  ...
  return (
    <>
        <View className='w-[80%] items-center mt-[6%]'>
            <View className={`w-full py-[14px] px-[8px] items-center rounded-2xl ${theme==='dark' ? 'bg-black' : 'bg-gray-600'} z-10`}>
            ...
            <LinearGradient
                ...
                style={{width: '100%', display: 'flex', alignItems: 'center', height: 480, borderRadius: 12, top: -22, backgroundColor: theme==='dark' ? 'bg-white/20' : 'bg-gray-400'}}
                start={{x:-1, y:1}}
                end={{x:2, y:1}}
            >
                <View className='w-full mt-[22px]'>
                    ...
                    <View className='flex-row items-center justify-evenly mt-[12px]'>
                        ...
                        <View className='flex w-[44%]'>
                            ...
                            <View className={`w-full flex items-center h-[90px] rounded-xl top-[-22px] ${theme==='dark' ? 'bg-white/20' : 'bg-gray-400'} `}>
        ...
        <View className='flex justify-center items-center w-[80%]'>
            ...
            <View className={`flex flex-row items-center justify-between ${theme==='dark' ? 'bg-white/60' : 'bg-black/40'} rounded-xl p-2 w-[80%]`}>
                ...
                <View className=''>
                    ...
                    {/* TO DO: Add pagination once other levels are made */}
                </View>
